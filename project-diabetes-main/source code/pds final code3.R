diabetes <- read.csv("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\data_raw//diabetes.csv")
...
write.csv(diabetes_clean, "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\data_clean\\diabetes_cleaned.csv", row.names = FALSE)

diabetes_clean = read.csv("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\data_clean\\diabetes_cleaned.csv")
...
write.table(result_df, file = "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\values", row.names = FALSE)
...
write.table(result_df, file = "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\Population", row.names = FALSE)
...
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\MeanComparison.png")
...
ggplot(max_data, aes(x = Type, y = Glucose, fill = Type)) +
  ...
  theme_bw()
# Save the plot as a png file
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\MaxComparison.png")
...
write.table(c(sample_bmi_percentile, pop_bmi_percentile), file = "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\percentiles.txt")
...
# Save the plot as a png file
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\98thpercentile.png")
...
write.table(result_df, file = "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\bootstrap mean values", row.names = FALSE)
...
write.table(result_df, file = "C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\pop mean percentile_values", row.names = FALSE)
...
# Save the plot as a png file
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\mean BP values_comparison.png")
...
# Save the plot as a png file
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\sd bp comparison.png")
...
# Save the plot as a png file
ggsave("C:\\Users\\sasik\\OneDrive\\Desktop\\project pds2\\results\\bloodpressure_comparison.png")